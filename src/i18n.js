...
const DICT = {
  vi: {
    ...
    'hint.2d': '<kbd>H</kbd> kéo nền · <kbd>M</kbd> mapled · <kbd>R</kbd> xoay 90° · <kbd>Del</kbd> xóa · <kbd>Ctrl+Cuộn</kbd> phóng',
    ...
    'toast.savedProject': 'Đã lưu "{name}"',
  ...
  en: {
    ...
    'hint.2d': '<kbd>H</kbd> pan · <kbd>M</kbd> mapled · <kbd>R</kbd> rotate 90° · <kbd>Del</kbd> remove · <kbd>Ctrl+Scroll</kbd> zoom',
