...
const DICT = {
  vi: {
    ...
    'toast.savedProject': 'Đã tải "{file}" về Downloads.',
    'projects.save.title': 'Lưu dự án',
    'projects.save.name': 'Tên dự án',
    'projects.save.mode': 'Chế độ lưu',
    'projects.save.light': 'Gọn nhẹ',
    'projects.save.light.desc': 'Chỉ bố cục LED + trạng thái khung nhìn. File nhỏ.',
    'projects.save.assets': 'Kèm tài nguyên',
    'projects.save.assets.desc': 'Nhúng cả mô hình 3D và ảnh/video của từng nhóm. Tự chứa nhưng nặng hơn.',
    'projects.save': 'Lưu',
    'projects.cancel': 'Hủy',
    'projects.open.modelNeeded': 'Cần mô hình 3D gốc',
    'projects.open.modelNeeded.body': 'Dự án này tham chiếu một mô hình 3D chưa được nạp. Hãy chọn lại file .dae / .gltf / .obj / .fbx gốc để khôi phục bố cục LED.',
    'projects.open.skip': 'Bỏ qua',
    'projects.open.useModel': 'Dùng file này',
  ...
  en: {
    ...
    'toast.savedProject': 'Saved "{file}" to Downloads.',
    'projects.save.title': 'Save project',
    'projects.save.name': 'Project name',
    'projects.save.mode': 'Save mode',
    'projects.save.light': 'Light',
    'projects.save.light.desc': 'Only LED layout + view. Smallest file.',
    'projects.save.assets': 'With assets',
    'projects.save.assets.desc': 'Embeds the 3D model and every group\'s image/video. Self-contained but larger.',
    'projects.save': 'Save',
    'projects.cancel': 'Cancel',
    'projects.open.modelNeeded': 'Source 3D model needed',
    'projects.open.modelNeeded.body': 'This project references a 3D model that isn\'t loaded yet. Select the original .dae / .gltf / .obj / .fbx file to restore the LED layout.',
    'projects.open.skip': 'Skip',
    'projects.open.useModel': 'Use this file',
